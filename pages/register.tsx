...
const register: NextPage = () => {
	...
	const handleSubmit =async (e:any) =>{
		e.preventDefault()
		setSubmitting(true)
		const response:boolean = await signup(email, password, name)
		setSubmitting(false)
        if(response === true){
            router.push('/')
        }
                    ...
                    <form className="mt-8 space-y-6"  onSubmit={(e) => handleSubmit(e)}>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="focus:outline-none backdrop-blur-md bg-white/30 rounded-md pl-3 w-full text-base py-2  "
                                type=""
